...
Revision ID: ade358b62638
Revises: 898ac2d9e9df
Create Date: 2024-08-25 09:35:36.325918
...
def upgrade():
    ...
    sa.Column('code', sa.String(length=16), server_default=sa.text("''"), nullable=False),
    sa.Column('name', sa.String(length=32), server_default=sa.text("''"), nullable=False),
    sa.Column('display', sa.String(length=32), server_default=sa.text("''"), nullable=False),
    ...
    sa.Column('visible', sa.SmallInteger(), nullable=False, server_default=sa.text("3")),
