...
Revision ID: 7218762c9a9a
Revises: 
Create Date: 2023-07-02 20:52:42.593958
...
def upgrade():
    ...
    sa.Column('col_meta', sa.String(length=1), server_default=sa.text("''"), nullable=False),
    sa.Column('data_type', sa.String(length=1), server_default=sa.text("''"), nullable=False),
