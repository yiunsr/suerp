...
async def script(config):
    ...
    async with SessionLocal() as db_session:
        ...
        param = {"code": "ugroup", "name_lang_jb": {
        ...
        param = {"code": "org", "name_lang_jb" :{
            "ko": "조직", "en": "organization"},  
            "detail": "person 의 그룹.  회사, 법인, 학교 같은 인명의 조직"}
        await add_table_meta(db_session, param)

        param = {"code": "per_org", "name_lang_jb": {
        ...
        param = {"code": "app_meta", "name_lang_jb": 
            {"ko": "앱", "en": "app"}, "detail": "app 정보"}
        await add_table_meta(db_session, param)
        ...
        param = {"code": "cate_meta", "name_lang_jb": 
