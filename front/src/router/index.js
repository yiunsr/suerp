...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/category_meta',
        name: 'category_meta_list',
        component: () => import('@/views/category_meta/List.vue'),
      },
      {
        path: '/category_meta/new',
        name: 'category_meta_new',
        component: () => import('@/views/category_meta/NewEdit.vue'),
      },
      {
        path: '/category_meta/:id',
        name: 'category_meta_edit',
        component: () => import('@/views/category_meta/NewEdit.vue'),
      },
